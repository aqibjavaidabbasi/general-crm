    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link menu-link {{ request()->is('*/dashboard') ? 'active' : '' }}" href="{{ route('home') }}">
                    <i class="ri-home-7-fill"></i> <span data-key="t-dashboard">Dashboard</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link menu-link {{ request()->is('*/media/*') ? 'active' : '' }}" href="{{ route('media.create') }}">
                    <i class="ri-video-upload-fill"></i> <span data-key="t-media">Media</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link menu-link {{ request()->is('*/blog/*') ? 'active' : '' }}" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                ...
                <div class="collapse menu-dropdown {{ request()->is('*/blog/*') ? 'show' : '' }}" id="sidebarApps">
                    <ul class="nav nav-sm flex-column">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('add-blog.create') }}" class="nav-link {{ Request::is('*/blog/add-blog/*') ? 'active' : '' }}" data-key="t-chat"> Add New Blog </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('blog-category.index') }}" class="nav-link {{ Request::is('*/blog-category/*') || Request::is('*/blog-category') ? 'active' : '' }}" data-key="t-chat"> Categories </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarEmail">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="apps-mailbox.html" class="nav-link" data-key="t-mailbox"> Blog Share Settings </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="apps-mailbox.html" class="nav-link" data-key="t-mailbox"> Comment Settings </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
