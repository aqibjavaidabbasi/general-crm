                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown {{ request()->is('*/blog/*') ? 'show' : '' }}" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="#sidebarEmail"
                                    class="nav-link {{ Request::is('*/comment-setting') || Request::is('*/blog-share-options') ? 'active' : '' }}"
                                    data-bs-toggle="collapse" role="button" aria-expanded="false"
                                    aria-controls="sidebarEmail" data-key="t-email">
                                    Settings
                                </a>
                                <div class="collapse menu-dropdown {{ Request::is('*/comment-setting') || Request::is('*/blog-share-options') ? 'show' : '' }}"
                                    id="sidebarEmail">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="{{ route('blog-share-options.index') }}"
                                                class="nav-link {{ Request::is('*/blog-share-options') ? 'active' : '' }}"
                                                data-key="t-mailbox"> Blog Share
                                                Settings </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('comment-setting.index') }}"
                                                class="nav-link {{ Request::is('*/comment-setting') ? 'active' : '' }}"
                                                data-key="t-mailbox"> Comment
                                                Settings </a>
                                        </li>
                                    </ul>
                                </div>
